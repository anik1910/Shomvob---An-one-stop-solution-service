...
namespace Shomvob
{
    public partial class MapInterfaceUser : Form
    {
        public MapInterfaceUser()
        {
            InitializeComponent();
        }
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sq1.Parameters.AddWithValue("@Vehicle", "Bike");
        ...
        private void MapInterfaceUser_Load(object sender, EventArgs e)
        {

        }

        private void ammount_OnValueChanged(object sender, EventArgs e)
        {
