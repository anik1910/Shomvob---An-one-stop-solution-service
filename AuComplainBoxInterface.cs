...
namespace Shomvob
{
    public partial class AuComplainBoxInterface : Form
    {
        public AuComplainBoxInterface()
        {
            InitializeComponent();
        }
        ...
        void populate()
        {
            ...
            {
                Con.Open();
                String Myquery = "select * from UserComplain";
        ...
        private void AuComplainBoxInterface_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        private void bunifuThinButton21_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String Myquery = "select * from UserComplain where UserName='" + username.Text + "'";
                SqlDataAdapter da = new SqlDataAdapter(Myquery, Con);
                SqlCommandBuilder builder = new SqlCommandBuilder(da);
                var ds = new DataSet();
                da.Fill(ds);
