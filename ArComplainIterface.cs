...
namespace Shomvob
{
    public partial class ArComplainIterface : Form
    {
        public ArComplainIterface()
        {
            InitializeComponent();
        }
        ...
        void populate()
        {
            ...
            {
                Con.Open();
                String Myquery = "select * from RiderComplain";
        ...
        private void ArComplainIterface_Load(object sender, EventArgs e)
        {
            populate();
        }
        ...
        private void bunifuThinButton21_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                String Myquery = "select * from RiderComplain where RiderName='" + username.Text + "'";
                SqlDataAdapter da = new SqlDataAdapter(Myquery, Con);
                SqlCommandBuilder builder = new SqlCommandBuilder(da);
                var ds = new DataSet();
                da.Fill(ds);
