...
namespace Shomvob
{
    public partial class MapInterfaceCNG : Form
    {
        public MapInterfaceCNG()
        {
            InitializeComponent();
        }
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sq1.Parameters.AddWithValue("@Vehicle", "CNG");
        ...
        private void MapInterfaceCNG_Load(object sender, EventArgs e)
        {
